package com.sinothk.helper.unlock.style1;
...
import com.sinothk.helper.unlock.R;

import java.util.ArrayList;
import java.util.List;

public class Unlock9View extends ViewGroup {
    ...
    public Unlock9View(@NonNull Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public Unlock9View(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public Unlock9View(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public Unlock9View(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
